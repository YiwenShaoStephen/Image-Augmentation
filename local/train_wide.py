...
parser.add_argument('--zoom-prob', default=0.0, type=float,
                    help="probability of doing random zoom transformation"
                    " on training data")
parser.add_argument('--zoom-range', nargs=2, default=[1, 1], type=float,
                    help="Range of zoom factor")
parser.add_argument('--rotation-prob', default=0.0, type=float,
                    help="probability of doing random rotation on training data")
parser.add_argument('--rotation-degree', nargs=2, default=[0, 0], type=float,
                    help="Range of rotation degree")
parser.add_argument('--stretch-prob', default=0.0, type=float,
                    help="probability of doing random stretch on training data")
parser.add_argument('--stretch-range', nargs=2, default=[1, 1], type=float,
                    help="Range of target aspect ratio after doing stretch")
...
def main():
    ...
    if args.augment:
        print("Doing image augmentation with\n"
